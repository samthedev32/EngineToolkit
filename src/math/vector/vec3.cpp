...
vec3::vec3(vec1 xyz) { this->x = xyz, this->y = xyz, this->z = xyz; }
vec3::vec3(vec1 x, vec1 y, vec1 z) { this->x = x, this->y = y, this->z = z; }
vec3::~vec3() {}
...
vec1 vec3::operator[](uint8_t i) const { return this->data[i % 3]; }
